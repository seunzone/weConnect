      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-3 col-md-6 footer-info">
            <h3>WeConnect</h3>
            <p>WeConnect provides a platform that brings businesses and individuals together. This platform
          ...
          <div className="col-lg-3 col-md-6 footer-info">
            ...
            <ul className="a__link">
              <li> <a href="https://andela.com" target="_blank">About Andela</a></li>
              <li> <a href="https://seunzone.github.io" target="_blank">About Seun</a></li>
              <li> <a href="https://github.com/seunzone/weConnect" target="_blank">Code on <i className="fa fa-github-alt" /> Github </a></li>
            </ul>
          </div>
